...
# - There are some journeys with 0 passengers, we keep these as there are probably weird situations where business people might send an urgent parcel alone to a destination in a cab or something, so it could be a valid entry
